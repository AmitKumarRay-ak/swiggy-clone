...
export default function Card(props) {
  return (
    <div className={`${props.width} shrink-0 mb-5`}>
      <div className="group h-[182px] rounded-[15px] overflow-hidden relative">
        <img
          ...
          alt=""
        />
        <div className="image-overlay absolute w-full h-full top-0 flex items-end justify-center text-[20px] md:text-[25px] font-bold text-white tracking-tighter">
          {props.offer}
        </div>
      </div>
